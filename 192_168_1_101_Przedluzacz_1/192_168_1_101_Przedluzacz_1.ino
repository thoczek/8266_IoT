...
void loop() 
{
  inputs[0]=digitalRead(14);
  inputs[1]=digitalRead(12);
  inputs[2]=digitalRead(13);
  inputs[3]=digitalRead(15);
  //inputs[4]=digitalRead(3);

  server.handleClient();

  digitalWrite(16, outputs[0]);
  digitalWrite(5, outputs[1]);
  digitalWrite(4, outputs[2]);
  digitalWrite(0, outputs[3]);
